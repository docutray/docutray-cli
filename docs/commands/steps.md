...
_See code: [src/commands/steps/run.ts](https://github.com/docutray/docutray-cli/blob/v0.2.1/src/commands/steps/run.ts)_
...
_See code: [src/commands/steps/status.ts](https://github.com/docutray/docutray-cli/blob/v0.2.1/src/commands/steps/status.ts)_
